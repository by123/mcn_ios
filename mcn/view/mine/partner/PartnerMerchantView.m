...
@interface PartnerMerchantView()

@property(strong, nonatomic)PartnerMerchantViewModel *mViewModel;
...
@implementation PartnerMerchantView
...
-(void)initView{
    ...
    _nameLabel = [[UILabel alloc]initWithFontFamily:[UIFont fontWithName:FONT_SEMIBOLD size:STFont(18)] text:MSG_EMPTY textAlignment:NSTextAlignmentLeft textColor:c10 backgroundColor:nil multiLine:NO];
...
-(void)updateView{
    ...
    _nameLabel.frame = CGRectMake(STWidth(15), STHeight(34), STWidth(265), STHeight(25));
