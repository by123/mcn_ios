...
-(void)initView{
    ...
    if(!IS_NS_STRING_EMPTY(mRightStr)){
        ...
        _rightBtn = [[UIButton alloc]initWithFont:STFont(15) text:mRightStr textColor:mRightColor backgroundColor:nil corner:0 borderWidth:0 borderColor:nil];
        _rightBtn.titleLabel.font = [UIFont fontWithName:FONT_SEMIBOLD size:STFont(15)];
        CGSize rightSize = [_rightBtn.titleLabel.text sizeWithMaxWidth:ScreenWidth font:STFont(15) fontName:FONT_SEMIBOLD];
        _rightBtn.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
        _rightBtn.frame = CGRectMake(ScreenWidth - rightSize.width - STWidth(20)-STWidth(15) , 0, rightSize.width + STWidth(20), NavigationBarHeight);
